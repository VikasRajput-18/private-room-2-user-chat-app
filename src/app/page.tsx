      ...
      <div className="w-full max-w-md space-y-8">
        ...
        {error === "room-full" && (
          <div className="bg-red-950/50 border border-red-900 p-4 text-center">
            ...
            <p className="text-zinc-500 text-xs mt-1">
              This room is at maxium capacity.
            </p>
          </div>
        )}
        ...
        <div className="border border-zinc-800 bg-zinc-900/50 p-6 backdrop-blur-md">
          <div className="space-y-5">
            ...
            <button
              className="w-full bg-zinc-100 text-black p-3 text-sm font-bold hover:bg-zinc-50 hover:text-black transition-colrs mt-2 cursor-pointer disabled:opacity-50
            "
              onClick={() => createRoom()}
              disabled={isPending}
            >
