        ...
        <div className="flex items-center gap-4">
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={copyLink}
                className="text-[10px] bg-zinc-800 hover:bg-zinc-700 px-2 py-0.5 rounded text-zinc-400 hover:text-zinc-200 transition-colors cursor-pointer capitalize"
              >
                {copyStatus}
              </button>
            </div>
        ...
        <div className="flex gap-4">
          <div className="flex-1 relative group">
            ...
            <input
              ...
              className="w-full bg-blac border border-zinc-800 focus:border-zinc-700 focus:outline-none transition-colors text-zinc-100 placeholder:text-zinc-700 py-2 pl-8 pr-4 text-sm"
            />
          </div>
          <button
